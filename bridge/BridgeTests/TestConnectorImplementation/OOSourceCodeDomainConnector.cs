...
namespace BridgeTests.TestConnectorImplementation
{
    ...
    public class TestOOSourceCodeDomainConnector : RegistrationFunctions, IOOSourceCodeDomainSoapBinding
    {
        #region Logger
        private static ILog logger = LogManager.GetLogger(typeof(TestOOSourceCodeDomainConnector));
        #endregion
        #region Constructors
        public TestOOSourceCodeDomainConnector()
        : base(logger)
        {
        }
        #endregion
