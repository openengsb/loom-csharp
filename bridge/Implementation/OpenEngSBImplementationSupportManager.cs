#region Copyright
// <copyright file="OpenEngSBImplementationSupportManager.cs" company="OpenEngSB">
...
{
    /// <summary>
    /// Adds a OpenEngSB implementation to the Support List (The factory can pick then 
    /// the correct Version)
    /// </summary>
